...
export const surveyQuestions: SurveyQuestion[] = [
  ...
  // Section 2: Policy Priorities
  {
    ...
    inputType: "radio",
    options: [
      { label: "1 - Not important", value: "1 - Not important" },
      { label: "2 - Slightly important", value: "2 - Slightly important" },
      { label: "3 - Moderately important", value: "3 - Moderately important" },
      { label: "4 - Important", value: "4 - Important" },
      { label: "5 - Very important", value: "5 - Very important" },
    ],
  },
  {
    id: "q11",
